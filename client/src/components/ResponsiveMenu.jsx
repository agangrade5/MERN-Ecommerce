            ...
            <div>
                ...
                <nav className='mt-12'>
                    <ul className='flex flex-col gap-7 text-2xl font-semibold'>
                        ...
                        <Link to={"/about-us"} onClick={() => setOpenNav(false)} className="cursor-pointer"><li>About</li></Link>
                        <Link to={"/contact-us"} onClick={() => setOpenNav(false)} className="cursor-pointer"><li>Contact</li></Link>
                    </ul>
                </nav>
            </div>
        </div>
