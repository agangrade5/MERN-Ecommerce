    ...
    return (
        <>
            <div className='bg-gray-100 flex justify-between items-center md:hidden px-4 p-2 mt-5'>
                <h1 className='font-semibold text-l'>Filters</h1>
            ...
            </div>
            {
                openFilter ? <div className='bg-gray-100 p-2 md:hidden'>
                    ...
                    {/* category only data */}
                    <h1 className='mt-5 font-semibold text-l'>Category</h1>
                    ...
                    {/* brand only data */}
                    <h1 className='mt-5 font-semibold text-l mb-3'>Brand</h1>
                    <select name="" id=""
                    ...
                    <button 
                        ...
                        onClick={() => { setSearch(''); setCategory('All'); setBrand('All'); setPriceRange([priceRangeMin, priceRangeMax]); setOpenFilter(false) }}
